...
if (d >= 21 and m == 3) or (d <= 20 and m == 4):
  ...
  print('Gemeos')
elif (d >= 23 and m == 7) or (dia <= 22 and m == 8):
  print('Leão')
elif (d >= 23 and m == 8) or (dia <= 22 and m == 9):
  print('Virgem')
elif (d >= 23 and m == 9) or (dia <= 22 and m == 10):
  print('Libra')
elif (d >= 23 and m == 10) or (dia <= 21 and m == 11):
  print('Escorpião')
elif (d >= 22 and m == 11) or (dia <= 21 and m == 12):
  print('Sagitário')
elif (d >= 22 and m == 12) or (dia <= 19 and m == 1):
  print('Aquário')
elif (d >= 20 and m == 1) or (dia <= 18 and m == 2):
  print('Capricórnio')
elif (d >= 19 and m == 2) or (dia <= 20 and m == 3):
  print('Peixes')
else:
  print('Data invalida.')