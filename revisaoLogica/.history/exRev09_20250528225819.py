...
if (d >= 21 and m 3) or (dia <= 20 and m == 4):
  ...
  print('Libra')
elif (d >= 21 and m 10) or (dia <= 20 and m == 11):
  print('Escorpião')
elif (d >= 21 and m 11) or (dia <= 20 and m == 12):
  print('Sagitário')
elif (d >= 21 and m 12) or (dia <= 20 and m == 1):
  print('Aquário')
elif (d >= 21 and 1) or (dia <= 20 and m == 2):
  print('Capricórnio')
elif (d >= 21 and m 2) or (dia <= 20 and m == 6):
